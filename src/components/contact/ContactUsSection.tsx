...
export default function ContactUsSection() {
  ...
  const address =
    settings.contact.address || "มหาวิทยาลัยสงขลานครินทร์ วิทยาเขตหาดใหญ่";
          ...
          <div className="space-y-5">
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed max-w-lg mb-4">
                ยินดีต้อนรับสู่ช่องทางการติดต่อ <strong>ชมรมมุสลิม มหาวิทยาลัยสงขลานครินทร์ วิทยาเขตหาดใหญ่ (ชมรมมุสลิม ม.อ.หาดใหญ่) MSSPSUHATYAI | Muslim Student Society PSU HATYAI</strong>
              </p>
              <p className="text-lg text-gray-700 leading-relaxed max-w-lg">
                เราพร้อมรับฟังทุกความคิดเห็น ข้อเสนอแนะ และข้อสอบถามจากท่าน
                ไม่ว่าจะเป็นเรื่องกิจกรรม การสมัครสมาชิก
                หรือความร่วมมือในโครงการต่าง ๆ
              </p>
            </div>
