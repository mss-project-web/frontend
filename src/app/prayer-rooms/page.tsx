...
export default function PrayerRoomsPage() {
  const PrayerRoomMap = dynamic(
    () =>
      import("@/components/prayer-rooms/PrayerRoomMap").then(
        (mod) => mod.default,
      ),
    {
      ssr: false,
  ...
  return (
    <main className="relative min-h-screen font-sans overflow-hidden bg-white">
      ...
      <section id="prayer-times" className="py-5 bg-gradient-to-br bg-sky-50">
      ...
      <section id="prayer-rooms-map" className="py-10 bg-gradient-to-br">
        <div className="mx-auto max-w-screen-xl px-4">
          <div className="mx-auto text-center">
            <h2 className="text-3xl font-extrabold text-blue-800 border-b-2 border-gray-300 inline-block pb-1 mb-4">
              แผนที่ห้องละหมาด
            </h2>
            <p className="text-gray-600 text-lg mb-4">
              คลิกที่จุดบนแผนที่เพื่อดูรายละเอียดห้องละหมาด
            </p>
          </div>
      ...
      <section className="py-10 bg-gradient-to-br">
        <div className="mx-auto max-w-screen-xl px-4">
          <div className="mx-auto text-center">
            <h2 className="text-3xl font-extrabold text-blue-800 border-b-2 border-gray-300 inline-block pb-1 mb-4">
              รายการห้องละหมาดทั้งหมด
            </h2>
            <p className="text-gray-600 text-lg">
              ห้องละหมาดที่มีให้บริการในมหาวิทยาลัย
            </p>
          </div>
          <PrayerRoomDisplay />
        </div>
      ...
      <section id="guidelines" className="py-10 bg-gradient-to-br bg-sky-50">
        <div className="mx-auto max-w-screen-xl px-4">
          <div className="mx-auto">
            <Guidelines />
          </div>
